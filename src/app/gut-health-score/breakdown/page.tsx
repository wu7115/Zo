        ...
        <Card className="shadow-xl">
          ...
          <CardContent className="space-y-4">
            <ScoreCategoryCard title="ZoGut Score" score={28} bgColorClass="bg-orange-100">
              <div className="grid grid-cols-3 gap-3 items-end"> {/* Added items-end for consistency */}
                <SubCategoryBlock name="Microbial Diversity" color="bg-orange-400" className="h-20 flex items-center justify-center col-span-3" />
              </div>
            </ScoreCategoryCard>

            <ScoreCategoryCard title="Hydration & Diet" score={11} bgColorClass="bg-stone-100">
              <div className="grid grid-cols-3 gap-3 items-end"> {/* Added items-end */}
